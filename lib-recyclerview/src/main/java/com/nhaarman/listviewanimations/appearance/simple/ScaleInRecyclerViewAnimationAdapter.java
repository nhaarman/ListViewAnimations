...
public class ScaleInRecyclerViewAnimationAdapter<T extends RecyclerView.ViewHolder> extends AnimationRecyclerViewAdapter<T> {
    ...
    public ScaleInRecyclerViewAnimationAdapter(@NonNull final RecyclerView.Adapter<T> adapter) {
        this(adapter, DEFAULT_SCALE_FROM);
    }

    public ScaleInRecyclerViewAnimationAdapter(@NonNull final RecyclerView.Adapter<T> adapter, final float scaleFrom) {
        super(adapter);
