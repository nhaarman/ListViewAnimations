 ...
 * resources.
 */
public abstract class ResourceAnimationRecyclerViewAdapter<T extends RecyclerView.ViewHolder> extends AnimationRecyclerViewAdapter<T> {

    @NonNull
    private final Context mContext;

    protected ResourceAnimationRecyclerViewAdapter(@NonNull final RecyclerView.Adapter<T> adapter, @NonNull final Context context) {
        super(adapter);
        mContext = context;
    }
