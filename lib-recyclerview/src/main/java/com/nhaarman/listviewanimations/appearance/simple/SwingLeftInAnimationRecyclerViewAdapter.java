...
public class SwingLeftInAnimationRecyclerViewAdapter<T extends RecyclerView.ViewHolder>
        extends SingleAnimationRecyclerViewAdapter<T> {

    private static final String TRANSLATION_X = "translationX";

    public SwingLeftInAnimationRecyclerViewAdapter(@NonNull final RecyclerView.Adapter<T> adapter) {
        super(adapter);
    }
