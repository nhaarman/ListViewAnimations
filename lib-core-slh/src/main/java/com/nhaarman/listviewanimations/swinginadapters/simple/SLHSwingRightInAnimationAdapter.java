 ...
 */
public class SLHSwingRightInAnimationAdapter extends SwingRightInAnimationAdapterGen<StickyListHeadersListView> {

    public SLHSwingRightInAnimationAdapter(@NonNull final BaseAdapter baseAdapter) {
        super(baseAdapter);
    }
}
