...
public class StickyListHeadersListViewWrapper implements ListViewWrapper {
    ...
    @NonNull
    private final StickyListHeadersListViewAbstract mListView;

    public StickyListHeadersListViewWrapper(@NonNull final StickyListHeadersListViewAbstract listView) {
        mListView = listView;
    }

    @NonNull
    @Override
    public StickyListHeadersListViewAbstract getListView() {
        return mListView;
    }
