...
public class SwipeDismissAdapter extends BaseAdapterDecorator {
	...
	/**
	 * A {@link android.view.View.OnTouchListener} that makes the list items in
	 * a {@link ListView} dismissable. {@link ListView} is given special
	 * treatment because by default it handles touches for its list items...
	 * i.e. it's in charge of drawing the pressed state (the list selector),
	 * handling list item clicks, etc.
	 * 
	 * <p>
	 * After creating the listener, the caller should also call
	 * {@link ListView#setOnScrollListener(android.widget.AbsListView.OnScrollListener)}
	 * , passing in the scroll listener returned by
	 * {@link #makeScrollListener()}. If a scroll listener is already assigned,
	 * the caller should still pass scroll changes through to this listener.
	 * This will ensure that this {@link SwipeDismissListViewTouchListener} is
	 ...
	 * 
	 * <p>
	 * For a generalized {@link android.view.View.OnTouchListener} that makes
	 * any view dismissable, see {@link SwipeDismissTouchListener}.
	 * </p>
	 * 
	...
	private static class SwipeDismissListViewTouchListener implements View.OnTouchListener {
		...
		/**
		 * Constructs a new swipe-to-dismiss touch listener for the given list
		 * view.
		 * 
		 * @param listView
		 *            The list view whose items should be dismissable.
		 * @param callback
		 *            The callback to trigger when the user has indicated that
